...
public class MyStackTest {
	...
	public void testPopStudent() 
	{
		try 
		{
			assertEquals(Double.valueOf(4.2), doubleS.pop());
			assertEquals(Double.valueOf(3.1), doubleS.pop());
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
		catch (StackUnderflowException e)
	...
	{
		/**
		 * Filled out Push, Pop, toString myself in original MyStack file
		 */
		try
		{
	...
	public void testToStringStudent() 
	{
		doubleS.push(5.5);
		doubleS.push(6.6);
		assertEquals("3.1, 4.2, 5.5, 6.6", doubleS.toString(", "));
	}
