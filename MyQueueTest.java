...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		//Filled out missing methods in original QueueTest file, created Student test case file as well 
	...
	public void testDequeueStudent() 
	{
		try
		{
			assertEquals(Double.valueOf(5.0), doubleQ.dequeue());
			assertEquals(Double.valueOf(6.0), doubleQ.dequeue());
			assertEquals(Double.valueOf(7.0), doubleQ.dequeue());
			doubleQ.dequeue();
	...
	public void testEnqueueStudent() 
	{
		try {
			...
			assertEquals(true, doubleQ.enqueue(6.7));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(9.8));
	...
	public void testToStringStudent() throws QueueOverflowException 
	{
		...
		doubleQ.enqueue(5.0);
		assertEquals("5.06.07.05.0", doubleQ.toString());
		doubleQ.enqueue(6.9);
		assertEquals("5.06.07.05.06.9", doubleQ.toString());
	}
